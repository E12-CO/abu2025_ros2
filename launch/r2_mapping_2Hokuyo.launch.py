...
def generate_launch_description():
    ...
    # Configuration file
    configuration_basename = LaunchConfiguration('configuration_basename', default='R2_hokuyo_mapping_2sensors.lua')
    ...
    hokuyo_front_instant = launch_ros.actions.Node(
        ...
        executable='urg_node',
        output='screen',
        parameters=[os.path.join(get_package_share_directory(pkg_name), 'R2/params_r2', 'R2_ust05.yaml')]
    )
    ...
    rf2o_instant = launch_ros.actions.Node(
        ...
        output='screen',
        parameters=[{
            'laser_scan_topic' : '/scan_hokuyo_r2',
...
#            rf2o_instant,
    ...
    cartographer_node = launch_ros.actions.Node(
        ...
        remappings=[
            ('/imu', '/imu/data_r2'),
            ('/scan_1', '/scan_hokuyo1_r2'),
            ('/scan_2', '/scan_hokuyo2_r2')
            ],
