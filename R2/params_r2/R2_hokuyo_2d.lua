...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 15  -- Number of range data for submaps in the 2D track builder  
...
TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians = math.rad(0.02)  -- Modify 1.0 to 0.1, increased sensitivity to movement
